...
func TestELEMENT07CorrectnessAgainstBigInt(t *testing.T) {
	modulus, _ := new(big.Int).SetString("305575282600598147064366597835842765637946836234533313619449416256579955273191170515862660842840002787201260452675701948989813180452907", 10)
...
func (z *Element07) mulCIOS(x *Element07) *Element07 {
	...
	// m = t[0]n'[0] mod W
	m = t[0] * 7610030435370242429

	// -----------------------------------
	// Second loop
	C = madd0(m, 10628547993903157291, t[0])

	C, t[0] = madd2(m, 9870212403660431806, t[1], C)

	C, t[1] = madd2(m, 6725075133110611691, t[2], C)

	C, t[2] = madd2(m, 9744765987902228134, t[3], C)

	C, t[3] = madd2(m, 16521546704004545539, t[4], C)

	C, t[4] = madd2(m, 11797444742220868934, t[5], C)

	C, t[5] = madd3(m, 7755322941616107992, t[6], C, t[7])
	...
	if t[7] != 0 {
		...
		var b uint64
		z[0], b = bits.Sub64(t[0], 10628547993903157291, 0)
		z[1], b = bits.Sub64(t[1], 9870212403660431806, b)
		z[2], b = bits.Sub64(t[2], 6725075133110611691, b)
		z[3], b = bits.Sub64(t[3], 9744765987902228134, b)
		z[4], b = bits.Sub64(t[4], 16521546704004545539, b)
		z[5], b = bits.Sub64(t[5], 11797444742220868934, b)
		z[6], _ = bits.Sub64(t[6], 7755322941616107992, b)
		return z
	}
...
func (z *Element07) mulFIPS(x *Element07) *Element07 {
	...
	p[0] = v * 7610030435370242429
	u, v, _ = madd(p[0], 10628547993903157291, 0, u, v)
	t, u, v = madd(z[0], x[1], 0, u, v)
	t, u, v = madd(p[0], 9870212403660431806, t, u, v)
	t, u, v = madd(z[1], x[0], t, u, v)
	p[1] = v * 7610030435370242429
	u, v, _ = madd(p[1], 10628547993903157291, t, u, v)
	t, u, v = madd(z[0], x[2], 0, u, v)
	t, u, v = madd(p[0], 6725075133110611691, t, u, v)
	t, u, v = madd(z[1], x[1], t, u, v)
	t, u, v = madd(p[1], 9870212403660431806, t, u, v)
	t, u, v = madd(z[2], x[0], t, u, v)
	p[2] = v * 7610030435370242429
	u, v, _ = madd(p[2], 10628547993903157291, t, u, v)
	t, u, v = madd(z[0], x[3], 0, u, v)
	t, u, v = madd(p[0], 9744765987902228134, t, u, v)
	t, u, v = madd(z[1], x[2], t, u, v)
	t, u, v = madd(p[1], 6725075133110611691, t, u, v)
	t, u, v = madd(z[2], x[1], t, u, v)
	t, u, v = madd(p[2], 9870212403660431806, t, u, v)
	t, u, v = madd(z[3], x[0], t, u, v)
	p[3] = v * 7610030435370242429
	u, v, _ = madd(p[3], 10628547993903157291, t, u, v)
	t, u, v = madd(z[0], x[4], 0, u, v)
	t, u, v = madd(p[0], 16521546704004545539, t, u, v)
	t, u, v = madd(z[1], x[3], t, u, v)
	t, u, v = madd(p[1], 9744765987902228134, t, u, v)
	t, u, v = madd(z[2], x[2], t, u, v)
	t, u, v = madd(p[2], 6725075133110611691, t, u, v)
	t, u, v = madd(z[3], x[1], t, u, v)
	t, u, v = madd(p[3], 9870212403660431806, t, u, v)
	t, u, v = madd(z[4], x[0], t, u, v)
	p[4] = v * 7610030435370242429
	u, v, _ = madd(p[4], 10628547993903157291, t, u, v)
	t, u, v = madd(z[0], x[5], 0, u, v)
	t, u, v = madd(p[0], 11797444742220868934, t, u, v)
	t, u, v = madd(z[1], x[4], t, u, v)
	t, u, v = madd(p[1], 16521546704004545539, t, u, v)
	t, u, v = madd(z[2], x[3], t, u, v)
	t, u, v = madd(p[2], 9744765987902228134, t, u, v)
	t, u, v = madd(z[3], x[2], t, u, v)
	t, u, v = madd(p[3], 6725075133110611691, t, u, v)
	t, u, v = madd(z[4], x[1], t, u, v)
	t, u, v = madd(p[4], 9870212403660431806, t, u, v)
	t, u, v = madd(z[5], x[0], t, u, v)
	p[5] = v * 7610030435370242429
	u, v, _ = madd(p[5], 10628547993903157291, t, u, v)
	t, u, v = madd(z[0], x[6], 0, u, v)
	t, u, v = madd(p[0], 7755322941616107992, t, u, v)
	t, u, v = madd(z[1], x[5], t, u, v)
	t, u, v = madd(p[1], 11797444742220868934, t, u, v)
	t, u, v = madd(z[2], x[4], t, u, v)
	t, u, v = madd(p[2], 16521546704004545539, t, u, v)
	t, u, v = madd(z[3], x[3], t, u, v)
	t, u, v = madd(p[3], 9744765987902228134, t, u, v)
	t, u, v = madd(z[4], x[2], t, u, v)
	t, u, v = madd(p[4], 6725075133110611691, t, u, v)
	t, u, v = madd(z[5], x[1], t, u, v)
	t, u, v = madd(p[5], 9870212403660431806, t, u, v)
	t, u, v = madd(z[6], x[0], t, u, v)
	p[6] = v * 7610030435370242429
	u, v, _ = madd(p[6], 10628547993903157291, t, u, v)
	t, u, v = madd(z[1], x[6], 0, u, v)
	t, u, v = madd(p[1], 7755322941616107992, t, u, v)
	t, u, v = madd(z[2], x[5], t, u, v)
	t, u, v = madd(p[2], 11797444742220868934, t, u, v)
	t, u, v = madd(z[3], x[4], t, u, v)
	t, u, v = madd(p[3], 16521546704004545539, t, u, v)
	t, u, v = madd(z[4], x[3], t, u, v)
	t, u, v = madd(p[4], 9744765987902228134, t, u, v)
	t, u, v = madd(z[5], x[2], t, u, v)
	t, u, v = madd(p[5], 6725075133110611691, t, u, v)
	t, u, v = madd(z[6], x[1], t, u, v)
	u, v, p[0] = madd(p[6], 9870212403660431806, t, u, v)
	t, u, v = madd(z[2], x[6], 0, u, v)
	t, u, v = madd(p[2], 7755322941616107992, t, u, v)
	t, u, v = madd(z[3], x[5], t, u, v)
	t, u, v = madd(p[3], 11797444742220868934, t, u, v)
	t, u, v = madd(z[4], x[4], t, u, v)
	t, u, v = madd(p[4], 16521546704004545539, t, u, v)
	t, u, v = madd(z[5], x[3], t, u, v)
	t, u, v = madd(p[5], 9744765987902228134, t, u, v)
	t, u, v = madd(z[6], x[2], t, u, v)
	u, v, p[1] = madd(p[6], 6725075133110611691, t, u, v)
	t, u, v = madd(z[3], x[6], 0, u, v)
	t, u, v = madd(p[3], 7755322941616107992, t, u, v)
	t, u, v = madd(z[4], x[5], t, u, v)
	t, u, v = madd(p[4], 11797444742220868934, t, u, v)
	t, u, v = madd(z[5], x[4], t, u, v)
	t, u, v = madd(p[5], 16521546704004545539, t, u, v)
	t, u, v = madd(z[6], x[3], t, u, v)
	u, v, p[2] = madd(p[6], 9744765987902228134, t, u, v)
	t, u, v = madd(z[4], x[6], 0, u, v)
	t, u, v = madd(p[4], 7755322941616107992, t, u, v)
	t, u, v = madd(z[5], x[5], t, u, v)
	t, u, v = madd(p[5], 11797444742220868934, t, u, v)
	t, u, v = madd(z[6], x[4], t, u, v)
	u, v, p[3] = madd(p[6], 16521546704004545539, t, u, v)
	t, u, v = madd(z[5], x[6], 0, u, v)
	t, u, v = madd(p[5], 7755322941616107992, t, u, v)
	t, u, v = madd(z[6], x[5], t, u, v)
	u, v, p[4] = madd(p[6], 11797444742220868934, t, u, v)
	t, u, v = madd(z[6], x[6], t, u, v)
	u, v, p[5] = madd(p[6], 7755322941616107992, t, u, v)
