...
func TestELEMENT07CorrectnessAgainstBigInt(t *testing.T) {
	modulus, _ := new(big.Int).SetString("294589162379062939807514145146906390616322669100874202731450106922687715835645469688240260895210363483933904587777051266029869625363279", 10)
...
func BenchmarkSqrtELEMENT07(b *testing.B) {
	var a Element07
	a.SetRandom()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		benchResElement07.Sqrt(&a)
	}
}
...
func (z *Element07) mulCIOS(x *Element07) *Element07 {
	...
	// m = t[0]n'[0] mod W
	m = t[0] * 8681169792171742289

	// -----------------------------------
	// Second loop
	C = madd0(m, 16283511405522832207, t[0])

	C, t[0] = madd2(m, 5765311806032840837, t[1], C)

	C, t[1] = madd2(m, 15099312709458841752, t[2], C)

	C, t[2] = madd2(m, 16581088499588203653, t[3], C)

	C, t[3] = madd2(m, 7928619430980946056, t[4], C)

	C, t[4] = madd2(m, 15421402179581806784, t[5], C)

	C, t[5] = madd3(m, 7476501600215971280, t[6], C, t[7])
	...
	if t[7] != 0 {
		...
		var b uint64
		z[0], b = bits.Sub64(t[0], 16283511405522832207, 0)
		z[1], b = bits.Sub64(t[1], 5765311806032840837, b)
		z[2], b = bits.Sub64(t[2], 15099312709458841752, b)
		z[3], b = bits.Sub64(t[3], 16581088499588203653, b)
		z[4], b = bits.Sub64(t[4], 7928619430980946056, b)
		z[5], b = bits.Sub64(t[5], 15421402179581806784, b)
		z[6], _ = bits.Sub64(t[6], 7476501600215971280, b)
		return z
	}
...
func (z *Element07) mulFIPS(x *Element07) *Element07 {
	...
	p[0] = v * 8681169792171742289
	u, v, _ = madd(p[0], 16283511405522832207, 0, u, v)
	t, u, v = madd(z[0], x[1], 0, u, v)
	t, u, v = madd(p[0], 5765311806032840837, t, u, v)
	t, u, v = madd(z[1], x[0], t, u, v)
	p[1] = v * 8681169792171742289
	u, v, _ = madd(p[1], 16283511405522832207, t, u, v)
	t, u, v = madd(z[0], x[2], 0, u, v)
	t, u, v = madd(p[0], 15099312709458841752, t, u, v)
	t, u, v = madd(z[1], x[1], t, u, v)
	t, u, v = madd(p[1], 5765311806032840837, t, u, v)
	t, u, v = madd(z[2], x[0], t, u, v)
	p[2] = v * 8681169792171742289
	u, v, _ = madd(p[2], 16283511405522832207, t, u, v)
	t, u, v = madd(z[0], x[3], 0, u, v)
	t, u, v = madd(p[0], 16581088499588203653, t, u, v)
	t, u, v = madd(z[1], x[2], t, u, v)
	t, u, v = madd(p[1], 15099312709458841752, t, u, v)
	t, u, v = madd(z[2], x[1], t, u, v)
	t, u, v = madd(p[2], 5765311806032840837, t, u, v)
	t, u, v = madd(z[3], x[0], t, u, v)
	p[3] = v * 8681169792171742289
	u, v, _ = madd(p[3], 16283511405522832207, t, u, v)
	t, u, v = madd(z[0], x[4], 0, u, v)
	t, u, v = madd(p[0], 7928619430980946056, t, u, v)
	t, u, v = madd(z[1], x[3], t, u, v)
	t, u, v = madd(p[1], 16581088499588203653, t, u, v)
	t, u, v = madd(z[2], x[2], t, u, v)
	t, u, v = madd(p[2], 15099312709458841752, t, u, v)
	t, u, v = madd(z[3], x[1], t, u, v)
	t, u, v = madd(p[3], 5765311806032840837, t, u, v)
	t, u, v = madd(z[4], x[0], t, u, v)
	p[4] = v * 8681169792171742289
	u, v, _ = madd(p[4], 16283511405522832207, t, u, v)
	t, u, v = madd(z[0], x[5], 0, u, v)
	t, u, v = madd(p[0], 15421402179581806784, t, u, v)
	t, u, v = madd(z[1], x[4], t, u, v)
	t, u, v = madd(p[1], 7928619430980946056, t, u, v)
	t, u, v = madd(z[2], x[3], t, u, v)
	t, u, v = madd(p[2], 16581088499588203653, t, u, v)
	t, u, v = madd(z[3], x[2], t, u, v)
	t, u, v = madd(p[3], 15099312709458841752, t, u, v)
	t, u, v = madd(z[4], x[1], t, u, v)
	t, u, v = madd(p[4], 5765311806032840837, t, u, v)
	t, u, v = madd(z[5], x[0], t, u, v)
	p[5] = v * 8681169792171742289
	u, v, _ = madd(p[5], 16283511405522832207, t, u, v)
	t, u, v = madd(z[0], x[6], 0, u, v)
	t, u, v = madd(p[0], 7476501600215971280, t, u, v)
	t, u, v = madd(z[1], x[5], t, u, v)
	t, u, v = madd(p[1], 15421402179581806784, t, u, v)
	t, u, v = madd(z[2], x[4], t, u, v)
	t, u, v = madd(p[2], 7928619430980946056, t, u, v)
	t, u, v = madd(z[3], x[3], t, u, v)
	t, u, v = madd(p[3], 16581088499588203653, t, u, v)
	t, u, v = madd(z[4], x[2], t, u, v)
	t, u, v = madd(p[4], 15099312709458841752, t, u, v)
	t, u, v = madd(z[5], x[1], t, u, v)
	t, u, v = madd(p[5], 5765311806032840837, t, u, v)
	t, u, v = madd(z[6], x[0], t, u, v)
	p[6] = v * 8681169792171742289
	u, v, _ = madd(p[6], 16283511405522832207, t, u, v)
	t, u, v = madd(z[1], x[6], 0, u, v)
	t, u, v = madd(p[1], 7476501600215971280, t, u, v)
	t, u, v = madd(z[2], x[5], t, u, v)
	t, u, v = madd(p[2], 15421402179581806784, t, u, v)
	t, u, v = madd(z[3], x[4], t, u, v)
	t, u, v = madd(p[3], 7928619430980946056, t, u, v)
	t, u, v = madd(z[4], x[3], t, u, v)
	t, u, v = madd(p[4], 16581088499588203653, t, u, v)
	t, u, v = madd(z[5], x[2], t, u, v)
	t, u, v = madd(p[5], 15099312709458841752, t, u, v)
	t, u, v = madd(z[6], x[1], t, u, v)
	u, v, p[0] = madd(p[6], 5765311806032840837, t, u, v)
	t, u, v = madd(z[2], x[6], 0, u, v)
	t, u, v = madd(p[2], 7476501600215971280, t, u, v)
	t, u, v = madd(z[3], x[5], t, u, v)
	t, u, v = madd(p[3], 15421402179581806784, t, u, v)
	t, u, v = madd(z[4], x[4], t, u, v)
	t, u, v = madd(p[4], 7928619430980946056, t, u, v)
	t, u, v = madd(z[5], x[3], t, u, v)
	t, u, v = madd(p[5], 16581088499588203653, t, u, v)
	t, u, v = madd(z[6], x[2], t, u, v)
	u, v, p[1] = madd(p[6], 15099312709458841752, t, u, v)
	t, u, v = madd(z[3], x[6], 0, u, v)
	t, u, v = madd(p[3], 7476501600215971280, t, u, v)
	t, u, v = madd(z[4], x[5], t, u, v)
	t, u, v = madd(p[4], 15421402179581806784, t, u, v)
	t, u, v = madd(z[5], x[4], t, u, v)
	t, u, v = madd(p[5], 7928619430980946056, t, u, v)
	t, u, v = madd(z[6], x[3], t, u, v)
	u, v, p[2] = madd(p[6], 16581088499588203653, t, u, v)
	t, u, v = madd(z[4], x[6], 0, u, v)
	t, u, v = madd(p[4], 7476501600215971280, t, u, v)
	t, u, v = madd(z[5], x[5], t, u, v)
	t, u, v = madd(p[5], 15421402179581806784, t, u, v)
	t, u, v = madd(z[6], x[4], t, u, v)
	u, v, p[3] = madd(p[6], 7928619430980946056, t, u, v)
	t, u, v = madd(z[5], x[6], 0, u, v)
	t, u, v = madd(p[5], 7476501600215971280, t, u, v)
	t, u, v = madd(z[6], x[5], t, u, v)
	u, v, p[4] = madd(p[6], 15421402179581806784, t, u, v)
	t, u, v = madd(z[6], x[6], t, u, v)
	u, v, p[5] = madd(p[6], 7476501600215971280, t, u, v)
