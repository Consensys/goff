...
func TestELEMENT05CorrectnessAgainstBigInt(t *testing.T) {
	modulus, _ := new(big.Int).SetString("801190289846909018449330465237032831488537931838481303757834212901239323445745183765263877838591", 10)
...
func (z *Element05) mulCIOS(x *Element05) *Element05 {
	...
	// m = t[0]n'[0] mod W
	m = t[0] * 10513151696181630721

	// -----------------------------------
	// Second loop
	C = madd0(m, 4037226758542628607, t[0])

	C, t[0] = madd2(m, 10260335205665271989, t[1], C)

	C, t[1] = madd2(m, 14864618863198748756, t[2], C)

	C, t[2] = madd2(m, 15971128581955862924, t[3], C)

	C, t[3] = madd3(m, 6919214387822879545, t[4], C, t[5])
	...
	if t[5] != 0 {
		...
		var b uint64
		z[0], b = bits.Sub64(t[0], 4037226758542628607, 0)
		z[1], b = bits.Sub64(t[1], 10260335205665271989, b)
		z[2], b = bits.Sub64(t[2], 14864618863198748756, b)
		z[3], b = bits.Sub64(t[3], 15971128581955862924, b)
		z[4], _ = bits.Sub64(t[4], 6919214387822879545, b)
		return z
	}
...
func (z *Element05) mulFIPS(x *Element05) *Element05 {
	...
	p[0] = v * 10513151696181630721
	u, v, _ = madd(p[0], 4037226758542628607, 0, u, v)
	t, u, v = madd(z[0], x[1], 0, u, v)
	t, u, v = madd(p[0], 10260335205665271989, t, u, v)
	t, u, v = madd(z[1], x[0], t, u, v)
	p[1] = v * 10513151696181630721
	u, v, _ = madd(p[1], 4037226758542628607, t, u, v)
	t, u, v = madd(z[0], x[2], 0, u, v)
	t, u, v = madd(p[0], 14864618863198748756, t, u, v)
	t, u, v = madd(z[1], x[1], t, u, v)
	t, u, v = madd(p[1], 10260335205665271989, t, u, v)
	t, u, v = madd(z[2], x[0], t, u, v)
	p[2] = v * 10513151696181630721
	u, v, _ = madd(p[2], 4037226758542628607, t, u, v)
	t, u, v = madd(z[0], x[3], 0, u, v)
	t, u, v = madd(p[0], 15971128581955862924, t, u, v)
	t, u, v = madd(z[1], x[2], t, u, v)
	t, u, v = madd(p[1], 14864618863198748756, t, u, v)
	t, u, v = madd(z[2], x[1], t, u, v)
	t, u, v = madd(p[2], 10260335205665271989, t, u, v)
	t, u, v = madd(z[3], x[0], t, u, v)
	p[3] = v * 10513151696181630721
	u, v, _ = madd(p[3], 4037226758542628607, t, u, v)
	t, u, v = madd(z[0], x[4], 0, u, v)
	t, u, v = madd(p[0], 6919214387822879545, t, u, v)
	t, u, v = madd(z[1], x[3], t, u, v)
	t, u, v = madd(p[1], 15971128581955862924, t, u, v)
	t, u, v = madd(z[2], x[2], t, u, v)
	t, u, v = madd(p[2], 14864618863198748756, t, u, v)
	t, u, v = madd(z[3], x[1], t, u, v)
	t, u, v = madd(p[3], 10260335205665271989, t, u, v)
	t, u, v = madd(z[4], x[0], t, u, v)
	p[4] = v * 10513151696181630721
	u, v, _ = madd(p[4], 4037226758542628607, t, u, v)
	t, u, v = madd(z[1], x[4], 0, u, v)
	t, u, v = madd(p[1], 6919214387822879545, t, u, v)
	t, u, v = madd(z[2], x[3], t, u, v)
	t, u, v = madd(p[2], 15971128581955862924, t, u, v)
	t, u, v = madd(z[3], x[2], t, u, v)
	t, u, v = madd(p[3], 14864618863198748756, t, u, v)
	t, u, v = madd(z[4], x[1], t, u, v)
	u, v, p[0] = madd(p[4], 10260335205665271989, t, u, v)
	t, u, v = madd(z[2], x[4], 0, u, v)
	t, u, v = madd(p[2], 6919214387822879545, t, u, v)
	t, u, v = madd(z[3], x[3], t, u, v)
	t, u, v = madd(p[3], 15971128581955862924, t, u, v)
	t, u, v = madd(z[4], x[2], t, u, v)
	u, v, p[1] = madd(p[4], 14864618863198748756, t, u, v)
	t, u, v = madd(z[3], x[4], 0, u, v)
	t, u, v = madd(p[3], 6919214387822879545, t, u, v)
	t, u, v = madd(z[4], x[3], t, u, v)
	u, v, p[2] = madd(p[4], 15971128581955862924, t, u, v)
	t, u, v = madd(z[4], x[4], t, u, v)
	u, v, p[3] = madd(p[4], 6919214387822879545, t, u, v)
