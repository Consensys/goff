...
func TestELEMENT05CorrectnessAgainstBigInt(t *testing.T) {
	modulus, _ := new(big.Int).SetString("934378582467464189700914053313996869525543880896321794320087268775301899163185860685514690237041", 10)
...
func (z *Element05) mulCIOS(x *Element05) *Element05 {
	...
	// m = t[0]n'[0] mod W
	m = t[0] * 2371522283029795183

	// -----------------------------------
	// Second loop
	C = madd0(m, 16635845003978183281, t[0])

	C, t[0] = madd2(m, 878730274788743613, t[1], C)

	C, t[1] = madd2(m, 12551308944693097678, t[2], C)

	C, t[2] = madd2(m, 16118007511075127249, t[3], C)

	C, t[3] = madd3(m, 8069450932459235580, t[4], C, t[5])
	...
	if t[5] != 0 {
		...
		var b uint64
		z[0], b = bits.Sub64(t[0], 16635845003978183281, 0)
		z[1], b = bits.Sub64(t[1], 878730274788743613, b)
		z[2], b = bits.Sub64(t[2], 12551308944693097678, b)
		z[3], b = bits.Sub64(t[3], 16118007511075127249, b)
		z[4], _ = bits.Sub64(t[4], 8069450932459235580, b)
		return z
	}
...
func (z *Element05) mulFIPS(x *Element05) *Element05 {
	...
	p[0] = v * 2371522283029795183
	u, v, _ = madd(p[0], 16635845003978183281, 0, u, v)
	t, u, v = madd(z[0], x[1], 0, u, v)
	t, u, v = madd(p[0], 878730274788743613, t, u, v)
	t, u, v = madd(z[1], x[0], t, u, v)
	p[1] = v * 2371522283029795183
	u, v, _ = madd(p[1], 16635845003978183281, t, u, v)
	t, u, v = madd(z[0], x[2], 0, u, v)
	t, u, v = madd(p[0], 12551308944693097678, t, u, v)
	t, u, v = madd(z[1], x[1], t, u, v)
	t, u, v = madd(p[1], 878730274788743613, t, u, v)
	t, u, v = madd(z[2], x[0], t, u, v)
	p[2] = v * 2371522283029795183
	u, v, _ = madd(p[2], 16635845003978183281, t, u, v)
	t, u, v = madd(z[0], x[3], 0, u, v)
	t, u, v = madd(p[0], 16118007511075127249, t, u, v)
	t, u, v = madd(z[1], x[2], t, u, v)
	t, u, v = madd(p[1], 12551308944693097678, t, u, v)
	t, u, v = madd(z[2], x[1], t, u, v)
	t, u, v = madd(p[2], 878730274788743613, t, u, v)
	t, u, v = madd(z[3], x[0], t, u, v)
	p[3] = v * 2371522283029795183
	u, v, _ = madd(p[3], 16635845003978183281, t, u, v)
	t, u, v = madd(z[0], x[4], 0, u, v)
	t, u, v = madd(p[0], 8069450932459235580, t, u, v)
	t, u, v = madd(z[1], x[3], t, u, v)
	t, u, v = madd(p[1], 16118007511075127249, t, u, v)
	t, u, v = madd(z[2], x[2], t, u, v)
	t, u, v = madd(p[2], 12551308944693097678, t, u, v)
	t, u, v = madd(z[3], x[1], t, u, v)
	t, u, v = madd(p[3], 878730274788743613, t, u, v)
	t, u, v = madd(z[4], x[0], t, u, v)
	p[4] = v * 2371522283029795183
	u, v, _ = madd(p[4], 16635845003978183281, t, u, v)
	t, u, v = madd(z[1], x[4], 0, u, v)
	t, u, v = madd(p[1], 8069450932459235580, t, u, v)
	t, u, v = madd(z[2], x[3], t, u, v)
	t, u, v = madd(p[2], 16118007511075127249, t, u, v)
	t, u, v = madd(z[3], x[2], t, u, v)
	t, u, v = madd(p[3], 12551308944693097678, t, u, v)
	t, u, v = madd(z[4], x[1], t, u, v)
	u, v, p[0] = madd(p[4], 878730274788743613, t, u, v)
	t, u, v = madd(z[2], x[4], 0, u, v)
	t, u, v = madd(p[2], 8069450932459235580, t, u, v)
	t, u, v = madd(z[3], x[3], t, u, v)
	t, u, v = madd(p[3], 16118007511075127249, t, u, v)
	t, u, v = madd(z[4], x[2], t, u, v)
	u, v, p[1] = madd(p[4], 12551308944693097678, t, u, v)
	t, u, v = madd(z[3], x[4], 0, u, v)
	t, u, v = madd(p[3], 8069450932459235580, t, u, v)
	t, u, v = madd(z[4], x[3], t, u, v)
	u, v, p[2] = madd(p[4], 16118007511075127249, t, u, v)
	t, u, v = madd(z[4], x[4], t, u, v)
	u, v, p[3] = madd(p[4], 8069450932459235580, t, u, v)
