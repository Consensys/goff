...
func TestELEMENT08CorrectnessAgainstBigInt(t *testing.T) {
	modulus, _ := new(big.Int).SetString("5315459662172859011258220130419388233248577625113445072854081173003977737777780266814780190928035591734755376868171945632522814298874106204538733428652143", 10)
...
func (z *Element08) mulCIOS(x *Element08) *Element08 {
	...
	// m = t[0]n'[0] mod W
	m = t[0] * 13514752438810859889

	// -----------------------------------
	// Second loop
	C = madd0(m, 865754355871692911, t[0])

	C, t[0] = madd2(m, 12484357880945639954, t[1], C)

	C, t[1] = madd2(m, 18305104478823612253, t[2], C)

	C, t[2] = madd2(m, 3362647424877458573, t[3], C)

	C, t[3] = madd2(m, 6941552521556805988, t[4], C)

	C, t[4] = madd2(m, 17268561149111174034, t[5], C)

	C, t[5] = madd2(m, 11079664472642879980, t[6], C)

	C, t[6] = madd3(m, 7313121170482724585, t[7], C, t[8])
	...
	if t[8] != 0 {
		...
		var b uint64
		z[0], b = bits.Sub64(t[0], 865754355871692911, 0)
		z[1], b = bits.Sub64(t[1], 12484357880945639954, b)
		z[2], b = bits.Sub64(t[2], 18305104478823612253, b)
		z[3], b = bits.Sub64(t[3], 3362647424877458573, b)
		z[4], b = bits.Sub64(t[4], 6941552521556805988, b)
		z[5], b = bits.Sub64(t[5], 17268561149111174034, b)
		z[6], b = bits.Sub64(t[6], 11079664472642879980, b)
		z[7], _ = bits.Sub64(t[7], 7313121170482724585, b)
		return z
	}
...
func (z *Element08) mulFIPS(x *Element08) *Element08 {
	...
	p[0] = v * 13514752438810859889
	u, v, _ = madd(p[0], 865754355871692911, 0, u, v)
	t, u, v = madd(z[0], x[1], 0, u, v)
	t, u, v = madd(p[0], 12484357880945639954, t, u, v)
	t, u, v = madd(z[1], x[0], t, u, v)
	p[1] = v * 13514752438810859889
	u, v, _ = madd(p[1], 865754355871692911, t, u, v)
	t, u, v = madd(z[0], x[2], 0, u, v)
	t, u, v = madd(p[0], 18305104478823612253, t, u, v)
	t, u, v = madd(z[1], x[1], t, u, v)
	t, u, v = madd(p[1], 12484357880945639954, t, u, v)
	t, u, v = madd(z[2], x[0], t, u, v)
	p[2] = v * 13514752438810859889
	u, v, _ = madd(p[2], 865754355871692911, t, u, v)
	t, u, v = madd(z[0], x[3], 0, u, v)
	t, u, v = madd(p[0], 3362647424877458573, t, u, v)
	t, u, v = madd(z[1], x[2], t, u, v)
	t, u, v = madd(p[1], 18305104478823612253, t, u, v)
	t, u, v = madd(z[2], x[1], t, u, v)
	t, u, v = madd(p[2], 12484357880945639954, t, u, v)
	t, u, v = madd(z[3], x[0], t, u, v)
	p[3] = v * 13514752438810859889
	u, v, _ = madd(p[3], 865754355871692911, t, u, v)
	t, u, v = madd(z[0], x[4], 0, u, v)
	t, u, v = madd(p[0], 6941552521556805988, t, u, v)
	t, u, v = madd(z[1], x[3], t, u, v)
	t, u, v = madd(p[1], 3362647424877458573, t, u, v)
	t, u, v = madd(z[2], x[2], t, u, v)
	t, u, v = madd(p[2], 18305104478823612253, t, u, v)
	t, u, v = madd(z[3], x[1], t, u, v)
	t, u, v = madd(p[3], 12484357880945639954, t, u, v)
	t, u, v = madd(z[4], x[0], t, u, v)
	p[4] = v * 13514752438810859889
	u, v, _ = madd(p[4], 865754355871692911, t, u, v)
	t, u, v = madd(z[0], x[5], 0, u, v)
	t, u, v = madd(p[0], 17268561149111174034, t, u, v)
	t, u, v = madd(z[1], x[4], t, u, v)
	t, u, v = madd(p[1], 6941552521556805988, t, u, v)
	t, u, v = madd(z[2], x[3], t, u, v)
	t, u, v = madd(p[2], 3362647424877458573, t, u, v)
	t, u, v = madd(z[3], x[2], t, u, v)
	t, u, v = madd(p[3], 18305104478823612253, t, u, v)
	t, u, v = madd(z[4], x[1], t, u, v)
	t, u, v = madd(p[4], 12484357880945639954, t, u, v)
	t, u, v = madd(z[5], x[0], t, u, v)
	p[5] = v * 13514752438810859889
	u, v, _ = madd(p[5], 865754355871692911, t, u, v)
	t, u, v = madd(z[0], x[6], 0, u, v)
	t, u, v = madd(p[0], 11079664472642879980, t, u, v)
	t, u, v = madd(z[1], x[5], t, u, v)
	t, u, v = madd(p[1], 17268561149111174034, t, u, v)
	t, u, v = madd(z[2], x[4], t, u, v)
	t, u, v = madd(p[2], 6941552521556805988, t, u, v)
	t, u, v = madd(z[3], x[3], t, u, v)
	t, u, v = madd(p[3], 3362647424877458573, t, u, v)
	t, u, v = madd(z[4], x[2], t, u, v)
	t, u, v = madd(p[4], 18305104478823612253, t, u, v)
	t, u, v = madd(z[5], x[1], t, u, v)
	t, u, v = madd(p[5], 12484357880945639954, t, u, v)
	t, u, v = madd(z[6], x[0], t, u, v)
	p[6] = v * 13514752438810859889
	u, v, _ = madd(p[6], 865754355871692911, t, u, v)
	t, u, v = madd(z[0], x[7], 0, u, v)
	t, u, v = madd(p[0], 7313121170482724585, t, u, v)
	t, u, v = madd(z[1], x[6], t, u, v)
	t, u, v = madd(p[1], 11079664472642879980, t, u, v)
	t, u, v = madd(z[2], x[5], t, u, v)
	t, u, v = madd(p[2], 17268561149111174034, t, u, v)
	t, u, v = madd(z[3], x[4], t, u, v)
	t, u, v = madd(p[3], 6941552521556805988, t, u, v)
	t, u, v = madd(z[4], x[3], t, u, v)
	t, u, v = madd(p[4], 3362647424877458573, t, u, v)
	t, u, v = madd(z[5], x[2], t, u, v)
	t, u, v = madd(p[5], 18305104478823612253, t, u, v)
	t, u, v = madd(z[6], x[1], t, u, v)
	t, u, v = madd(p[6], 12484357880945639954, t, u, v)
	t, u, v = madd(z[7], x[0], t, u, v)
	p[7] = v * 13514752438810859889
	u, v, _ = madd(p[7], 865754355871692911, t, u, v)
	t, u, v = madd(z[1], x[7], 0, u, v)
	t, u, v = madd(p[1], 7313121170482724585, t, u, v)
	t, u, v = madd(z[2], x[6], t, u, v)
	t, u, v = madd(p[2], 11079664472642879980, t, u, v)
	t, u, v = madd(z[3], x[5], t, u, v)
	t, u, v = madd(p[3], 17268561149111174034, t, u, v)
	t, u, v = madd(z[4], x[4], t, u, v)
	t, u, v = madd(p[4], 6941552521556805988, t, u, v)
	t, u, v = madd(z[5], x[3], t, u, v)
	t, u, v = madd(p[5], 3362647424877458573, t, u, v)
	t, u, v = madd(z[6], x[2], t, u, v)
	t, u, v = madd(p[6], 18305104478823612253, t, u, v)
	t, u, v = madd(z[7], x[1], t, u, v)
	u, v, p[0] = madd(p[7], 12484357880945639954, t, u, v)
	t, u, v = madd(z[2], x[7], 0, u, v)
	t, u, v = madd(p[2], 7313121170482724585, t, u, v)
	t, u, v = madd(z[3], x[6], t, u, v)
	t, u, v = madd(p[3], 11079664472642879980, t, u, v)
	t, u, v = madd(z[4], x[5], t, u, v)
	t, u, v = madd(p[4], 17268561149111174034, t, u, v)
	t, u, v = madd(z[5], x[4], t, u, v)
	t, u, v = madd(p[5], 6941552521556805988, t, u, v)
	t, u, v = madd(z[6], x[3], t, u, v)
	t, u, v = madd(p[6], 3362647424877458573, t, u, v)
	t, u, v = madd(z[7], x[2], t, u, v)
	u, v, p[1] = madd(p[7], 18305104478823612253, t, u, v)
	t, u, v = madd(z[3], x[7], 0, u, v)
	t, u, v = madd(p[3], 7313121170482724585, t, u, v)
	t, u, v = madd(z[4], x[6], t, u, v)
	t, u, v = madd(p[4], 11079664472642879980, t, u, v)
	t, u, v = madd(z[5], x[5], t, u, v)
	t, u, v = madd(p[5], 17268561149111174034, t, u, v)
	t, u, v = madd(z[6], x[4], t, u, v)
	t, u, v = madd(p[6], 6941552521556805988, t, u, v)
	t, u, v = madd(z[7], x[3], t, u, v)
	u, v, p[2] = madd(p[7], 3362647424877458573, t, u, v)
	t, u, v = madd(z[4], x[7], 0, u, v)
	t, u, v = madd(p[4], 7313121170482724585, t, u, v)
	t, u, v = madd(z[5], x[6], t, u, v)
	t, u, v = madd(p[5], 11079664472642879980, t, u, v)
	t, u, v = madd(z[6], x[5], t, u, v)
	t, u, v = madd(p[6], 17268561149111174034, t, u, v)
	t, u, v = madd(z[7], x[4], t, u, v)
	u, v, p[3] = madd(p[7], 6941552521556805988, t, u, v)
	t, u, v = madd(z[5], x[7], 0, u, v)
	t, u, v = madd(p[5], 7313121170482724585, t, u, v)
	t, u, v = madd(z[6], x[6], t, u, v)
	t, u, v = madd(p[6], 11079664472642879980, t, u, v)
	t, u, v = madd(z[7], x[5], t, u, v)
	u, v, p[4] = madd(p[7], 17268561149111174034, t, u, v)
	t, u, v = madd(z[6], x[7], 0, u, v)
	t, u, v = madd(p[6], 7313121170482724585, t, u, v)
	t, u, v = madd(z[7], x[6], t, u, v)
	u, v, p[5] = madd(p[7], 11079664472642879980, t, u, v)
	t, u, v = madd(z[7], x[7], t, u, v)
	u, v, p[6] = madd(p[7], 7313121170482724585, t, u, v)
