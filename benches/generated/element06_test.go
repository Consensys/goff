...
func TestELEMENT06CorrectnessAgainstBigInt(t *testing.T) {
	modulus, _ := new(big.Int).SetString("18953570851588973876708167949442091446016531442607261217486265350641612262702462660007962060480366104462554256737081", 10)
...
func (z *Element06) mulCIOS(x *Element06) *Element06 {
	...
	// m = t[0]n'[0] mod W
	m = t[0] * 4332547127410263287

	// -----------------------------------
	// Second loop
	C = madd0(m, 278209013915943737, t[0])

	C, t[0] = madd2(m, 9216729399889499093, t[1], C)

	C, t[1] = madd2(m, 7503156226612403498, t[2], C)

	C, t[2] = madd2(m, 11227163334849198561, t[3], C)

	C, t[3] = madd2(m, 5180024972610701416, t[4], C)

	C, t[4] = madd3(m, 8873448449286737236, t[5], C, t[6])
	...
	if t[6] != 0 {
		...
		var b uint64
		z[0], b = bits.Sub64(t[0], 278209013915943737, 0)
		z[1], b = bits.Sub64(t[1], 9216729399889499093, b)
		z[2], b = bits.Sub64(t[2], 7503156226612403498, b)
		z[3], b = bits.Sub64(t[3], 11227163334849198561, b)
		z[4], b = bits.Sub64(t[4], 5180024972610701416, b)
		z[5], _ = bits.Sub64(t[5], 8873448449286737236, b)
		return z
	}
...
func (z *Element06) mulFIPS(x *Element06) *Element06 {
	...
	p[0] = v * 4332547127410263287
	u, v, _ = madd(p[0], 278209013915943737, 0, u, v)
	t, u, v = madd(z[0], x[1], 0, u, v)
	t, u, v = madd(p[0], 9216729399889499093, t, u, v)
	t, u, v = madd(z[1], x[0], t, u, v)
	p[1] = v * 4332547127410263287
	u, v, _ = madd(p[1], 278209013915943737, t, u, v)
	t, u, v = madd(z[0], x[2], 0, u, v)
	t, u, v = madd(p[0], 7503156226612403498, t, u, v)
	t, u, v = madd(z[1], x[1], t, u, v)
	t, u, v = madd(p[1], 9216729399889499093, t, u, v)
	t, u, v = madd(z[2], x[0], t, u, v)
	p[2] = v * 4332547127410263287
	u, v, _ = madd(p[2], 278209013915943737, t, u, v)
	t, u, v = madd(z[0], x[3], 0, u, v)
	t, u, v = madd(p[0], 11227163334849198561, t, u, v)
	t, u, v = madd(z[1], x[2], t, u, v)
	t, u, v = madd(p[1], 7503156226612403498, t, u, v)
	t, u, v = madd(z[2], x[1], t, u, v)
	t, u, v = madd(p[2], 9216729399889499093, t, u, v)
	t, u, v = madd(z[3], x[0], t, u, v)
	p[3] = v * 4332547127410263287
	u, v, _ = madd(p[3], 278209013915943737, t, u, v)
	t, u, v = madd(z[0], x[4], 0, u, v)
	t, u, v = madd(p[0], 5180024972610701416, t, u, v)
	t, u, v = madd(z[1], x[3], t, u, v)
	t, u, v = madd(p[1], 11227163334849198561, t, u, v)
	t, u, v = madd(z[2], x[2], t, u, v)
	t, u, v = madd(p[2], 7503156226612403498, t, u, v)
	t, u, v = madd(z[3], x[1], t, u, v)
	t, u, v = madd(p[3], 9216729399889499093, t, u, v)
	t, u, v = madd(z[4], x[0], t, u, v)
	p[4] = v * 4332547127410263287
	u, v, _ = madd(p[4], 278209013915943737, t, u, v)
	t, u, v = madd(z[0], x[5], 0, u, v)
	t, u, v = madd(p[0], 8873448449286737236, t, u, v)
	t, u, v = madd(z[1], x[4], t, u, v)
	t, u, v = madd(p[1], 5180024972610701416, t, u, v)
	t, u, v = madd(z[2], x[3], t, u, v)
	t, u, v = madd(p[2], 11227163334849198561, t, u, v)
	t, u, v = madd(z[3], x[2], t, u, v)
	t, u, v = madd(p[3], 7503156226612403498, t, u, v)
	t, u, v = madd(z[4], x[1], t, u, v)
	t, u, v = madd(p[4], 9216729399889499093, t, u, v)
	t, u, v = madd(z[5], x[0], t, u, v)
	p[5] = v * 4332547127410263287
	u, v, _ = madd(p[5], 278209013915943737, t, u, v)
	t, u, v = madd(z[1], x[5], 0, u, v)
	t, u, v = madd(p[1], 8873448449286737236, t, u, v)
	t, u, v = madd(z[2], x[4], t, u, v)
	t, u, v = madd(p[2], 5180024972610701416, t, u, v)
	t, u, v = madd(z[3], x[3], t, u, v)
	t, u, v = madd(p[3], 11227163334849198561, t, u, v)
	t, u, v = madd(z[4], x[2], t, u, v)
	t, u, v = madd(p[4], 7503156226612403498, t, u, v)
	t, u, v = madd(z[5], x[1], t, u, v)
	u, v, p[0] = madd(p[5], 9216729399889499093, t, u, v)
	t, u, v = madd(z[2], x[5], 0, u, v)
	t, u, v = madd(p[2], 8873448449286737236, t, u, v)
	t, u, v = madd(z[3], x[4], t, u, v)
	t, u, v = madd(p[3], 5180024972610701416, t, u, v)
	t, u, v = madd(z[4], x[3], t, u, v)
	t, u, v = madd(p[4], 11227163334849198561, t, u, v)
	t, u, v = madd(z[5], x[2], t, u, v)
	u, v, p[1] = madd(p[5], 7503156226612403498, t, u, v)
	t, u, v = madd(z[3], x[5], 0, u, v)
	t, u, v = madd(p[3], 8873448449286737236, t, u, v)
	t, u, v = madd(z[4], x[4], t, u, v)
	t, u, v = madd(p[4], 5180024972610701416, t, u, v)
	t, u, v = madd(z[5], x[3], t, u, v)
	u, v, p[2] = madd(p[5], 11227163334849198561, t, u, v)
	t, u, v = madd(z[4], x[5], 0, u, v)
	t, u, v = madd(p[4], 8873448449286737236, t, u, v)
	t, u, v = madd(z[5], x[4], t, u, v)
	u, v, p[3] = madd(p[5], 5180024972610701416, t, u, v)
	t, u, v = madd(z[5], x[5], t, u, v)
	u, v, p[4] = madd(p[5], 8873448449286737236, t, u, v)
