...
func TestELEMENT09CorrectnessAgainstBigInt(t *testing.T) {
	modulus, _ := new(big.Int).SetString("109753244289369218107914749034851295640134514368942324019726722014210317606607217333571772724753082086870762304430223509176119550660605745576528876055410743510282298287889741", 10)
...
func (z *Element09) mulCIOS(x *Element09) *Element09 {
	...
	// m = t[0]n'[0] mod W
	m = t[0] * 8272132149667830907

	// -----------------------------------
	// Second loop
	C = madd0(m, 4039087338483785037, t[0])

	C, t[0] = madd2(m, 5503103695241318006, t[1], C)

	C, t[1] = madd2(m, 312781645394478490, t[2], C)

	C, t[2] = madd2(m, 2111677989222233149, t[3], C)

	C, t[3] = madd2(m, 7563895586719418401, t[4], C)

	C, t[4] = madd2(m, 10744876698608693643, t[5], C)

	C, t[5] = madd2(m, 2921755808891797364, t[6], C)

	C, t[6] = madd2(m, 3076118948115518168, t[7], C)

	C, t[7] = madd3(m, 8185770922647689293, t[8], C, t[9])
	...
	if t[9] != 0 {
		...
		var b uint64
		z[0], b = bits.Sub64(t[0], 4039087338483785037, 0)
		z[1], b = bits.Sub64(t[1], 5503103695241318006, b)
		z[2], b = bits.Sub64(t[2], 312781645394478490, b)
		z[3], b = bits.Sub64(t[3], 2111677989222233149, b)
		z[4], b = bits.Sub64(t[4], 7563895586719418401, b)
		z[5], b = bits.Sub64(t[5], 10744876698608693643, b)
		z[6], b = bits.Sub64(t[6], 2921755808891797364, b)
		z[7], b = bits.Sub64(t[7], 3076118948115518168, b)
		z[8], _ = bits.Sub64(t[8], 8185770922647689293, b)
		return z
	}
...
func (z *Element09) mulFIPS(x *Element09) *Element09 {
	...
	p[0] = v * 8272132149667830907
	u, v, _ = madd(p[0], 4039087338483785037, 0, u, v)
	t, u, v = madd(z[0], x[1], 0, u, v)
	t, u, v = madd(p[0], 5503103695241318006, t, u, v)
	t, u, v = madd(z[1], x[0], t, u, v)
	p[1] = v * 8272132149667830907
	u, v, _ = madd(p[1], 4039087338483785037, t, u, v)
	t, u, v = madd(z[0], x[2], 0, u, v)
	t, u, v = madd(p[0], 312781645394478490, t, u, v)
	t, u, v = madd(z[1], x[1], t, u, v)
	t, u, v = madd(p[1], 5503103695241318006, t, u, v)
	t, u, v = madd(z[2], x[0], t, u, v)
	p[2] = v * 8272132149667830907
	u, v, _ = madd(p[2], 4039087338483785037, t, u, v)
	t, u, v = madd(z[0], x[3], 0, u, v)
	t, u, v = madd(p[0], 2111677989222233149, t, u, v)
	t, u, v = madd(z[1], x[2], t, u, v)
	t, u, v = madd(p[1], 312781645394478490, t, u, v)
	t, u, v = madd(z[2], x[1], t, u, v)
	t, u, v = madd(p[2], 5503103695241318006, t, u, v)
	t, u, v = madd(z[3], x[0], t, u, v)
	p[3] = v * 8272132149667830907
	u, v, _ = madd(p[3], 4039087338483785037, t, u, v)
	t, u, v = madd(z[0], x[4], 0, u, v)
	t, u, v = madd(p[0], 7563895586719418401, t, u, v)
	t, u, v = madd(z[1], x[3], t, u, v)
	t, u, v = madd(p[1], 2111677989222233149, t, u, v)
	t, u, v = madd(z[2], x[2], t, u, v)
	t, u, v = madd(p[2], 312781645394478490, t, u, v)
	t, u, v = madd(z[3], x[1], t, u, v)
	t, u, v = madd(p[3], 5503103695241318006, t, u, v)
	t, u, v = madd(z[4], x[0], t, u, v)
	p[4] = v * 8272132149667830907
	u, v, _ = madd(p[4], 4039087338483785037, t, u, v)
	t, u, v = madd(z[0], x[5], 0, u, v)
	t, u, v = madd(p[0], 10744876698608693643, t, u, v)
	t, u, v = madd(z[1], x[4], t, u, v)
	t, u, v = madd(p[1], 7563895586719418401, t, u, v)
	t, u, v = madd(z[2], x[3], t, u, v)
	t, u, v = madd(p[2], 2111677989222233149, t, u, v)
	t, u, v = madd(z[3], x[2], t, u, v)
	t, u, v = madd(p[3], 312781645394478490, t, u, v)
	t, u, v = madd(z[4], x[1], t, u, v)
	t, u, v = madd(p[4], 5503103695241318006, t, u, v)
	t, u, v = madd(z[5], x[0], t, u, v)
	p[5] = v * 8272132149667830907
	u, v, _ = madd(p[5], 4039087338483785037, t, u, v)
	t, u, v = madd(z[0], x[6], 0, u, v)
	t, u, v = madd(p[0], 2921755808891797364, t, u, v)
	t, u, v = madd(z[1], x[5], t, u, v)
	t, u, v = madd(p[1], 10744876698608693643, t, u, v)
	t, u, v = madd(z[2], x[4], t, u, v)
	t, u, v = madd(p[2], 7563895586719418401, t, u, v)
	t, u, v = madd(z[3], x[3], t, u, v)
	t, u, v = madd(p[3], 2111677989222233149, t, u, v)
	t, u, v = madd(z[4], x[2], t, u, v)
	t, u, v = madd(p[4], 312781645394478490, t, u, v)
	t, u, v = madd(z[5], x[1], t, u, v)
	t, u, v = madd(p[5], 5503103695241318006, t, u, v)
	t, u, v = madd(z[6], x[0], t, u, v)
	p[6] = v * 8272132149667830907
	u, v, _ = madd(p[6], 4039087338483785037, t, u, v)
	t, u, v = madd(z[0], x[7], 0, u, v)
	t, u, v = madd(p[0], 3076118948115518168, t, u, v)
	t, u, v = madd(z[1], x[6], t, u, v)
	t, u, v = madd(p[1], 2921755808891797364, t, u, v)
	t, u, v = madd(z[2], x[5], t, u, v)
	t, u, v = madd(p[2], 10744876698608693643, t, u, v)
	t, u, v = madd(z[3], x[4], t, u, v)
	t, u, v = madd(p[3], 7563895586719418401, t, u, v)
	t, u, v = madd(z[4], x[3], t, u, v)
	t, u, v = madd(p[4], 2111677989222233149, t, u, v)
	t, u, v = madd(z[5], x[2], t, u, v)
	t, u, v = madd(p[5], 312781645394478490, t, u, v)
	t, u, v = madd(z[6], x[1], t, u, v)
	t, u, v = madd(p[6], 5503103695241318006, t, u, v)
	t, u, v = madd(z[7], x[0], t, u, v)
	p[7] = v * 8272132149667830907
	u, v, _ = madd(p[7], 4039087338483785037, t, u, v)
	t, u, v = madd(z[0], x[8], 0, u, v)
	t, u, v = madd(p[0], 8185770922647689293, t, u, v)
	t, u, v = madd(z[1], x[7], t, u, v)
	t, u, v = madd(p[1], 3076118948115518168, t, u, v)
	t, u, v = madd(z[2], x[6], t, u, v)
	t, u, v = madd(p[2], 2921755808891797364, t, u, v)
	t, u, v = madd(z[3], x[5], t, u, v)
	t, u, v = madd(p[3], 10744876698608693643, t, u, v)
	t, u, v = madd(z[4], x[4], t, u, v)
	t, u, v = madd(p[4], 7563895586719418401, t, u, v)
	t, u, v = madd(z[5], x[3], t, u, v)
	t, u, v = madd(p[5], 2111677989222233149, t, u, v)
	t, u, v = madd(z[6], x[2], t, u, v)
	t, u, v = madd(p[6], 312781645394478490, t, u, v)
	t, u, v = madd(z[7], x[1], t, u, v)
	t, u, v = madd(p[7], 5503103695241318006, t, u, v)
	t, u, v = madd(z[8], x[0], t, u, v)
	p[8] = v * 8272132149667830907
	u, v, _ = madd(p[8], 4039087338483785037, t, u, v)
	t, u, v = madd(z[1], x[8], 0, u, v)
	t, u, v = madd(p[1], 8185770922647689293, t, u, v)
	t, u, v = madd(z[2], x[7], t, u, v)
	t, u, v = madd(p[2], 3076118948115518168, t, u, v)
	t, u, v = madd(z[3], x[6], t, u, v)
	t, u, v = madd(p[3], 2921755808891797364, t, u, v)
	t, u, v = madd(z[4], x[5], t, u, v)
	t, u, v = madd(p[4], 10744876698608693643, t, u, v)
	t, u, v = madd(z[5], x[4], t, u, v)
	t, u, v = madd(p[5], 7563895586719418401, t, u, v)
	t, u, v = madd(z[6], x[3], t, u, v)
	t, u, v = madd(p[6], 2111677989222233149, t, u, v)
	t, u, v = madd(z[7], x[2], t, u, v)
	t, u, v = madd(p[7], 312781645394478490, t, u, v)
	t, u, v = madd(z[8], x[1], t, u, v)
	u, v, p[0] = madd(p[8], 5503103695241318006, t, u, v)
	t, u, v = madd(z[2], x[8], 0, u, v)
	t, u, v = madd(p[2], 8185770922647689293, t, u, v)
	t, u, v = madd(z[3], x[7], t, u, v)
	t, u, v = madd(p[3], 3076118948115518168, t, u, v)
	t, u, v = madd(z[4], x[6], t, u, v)
	t, u, v = madd(p[4], 2921755808891797364, t, u, v)
	t, u, v = madd(z[5], x[5], t, u, v)
	t, u, v = madd(p[5], 10744876698608693643, t, u, v)
	t, u, v = madd(z[6], x[4], t, u, v)
	t, u, v = madd(p[6], 7563895586719418401, t, u, v)
	t, u, v = madd(z[7], x[3], t, u, v)
	t, u, v = madd(p[7], 2111677989222233149, t, u, v)
	t, u, v = madd(z[8], x[2], t, u, v)
	u, v, p[1] = madd(p[8], 312781645394478490, t, u, v)
	t, u, v = madd(z[3], x[8], 0, u, v)
	t, u, v = madd(p[3], 8185770922647689293, t, u, v)
	t, u, v = madd(z[4], x[7], t, u, v)
	t, u, v = madd(p[4], 3076118948115518168, t, u, v)
	t, u, v = madd(z[5], x[6], t, u, v)
	t, u, v = madd(p[5], 2921755808891797364, t, u, v)
	t, u, v = madd(z[6], x[5], t, u, v)
	t, u, v = madd(p[6], 10744876698608693643, t, u, v)
	t, u, v = madd(z[7], x[4], t, u, v)
	t, u, v = madd(p[7], 7563895586719418401, t, u, v)
	t, u, v = madd(z[8], x[3], t, u, v)
	u, v, p[2] = madd(p[8], 2111677989222233149, t, u, v)
	t, u, v = madd(z[4], x[8], 0, u, v)
	t, u, v = madd(p[4], 8185770922647689293, t, u, v)
	t, u, v = madd(z[5], x[7], t, u, v)
	t, u, v = madd(p[5], 3076118948115518168, t, u, v)
	t, u, v = madd(z[6], x[6], t, u, v)
	t, u, v = madd(p[6], 2921755808891797364, t, u, v)
	t, u, v = madd(z[7], x[5], t, u, v)
	t, u, v = madd(p[7], 10744876698608693643, t, u, v)
	t, u, v = madd(z[8], x[4], t, u, v)
	u, v, p[3] = madd(p[8], 7563895586719418401, t, u, v)
	t, u, v = madd(z[5], x[8], 0, u, v)
	t, u, v = madd(p[5], 8185770922647689293, t, u, v)
	t, u, v = madd(z[6], x[7], t, u, v)
	t, u, v = madd(p[6], 3076118948115518168, t, u, v)
	t, u, v = madd(z[7], x[6], t, u, v)
	t, u, v = madd(p[7], 2921755808891797364, t, u, v)
	t, u, v = madd(z[8], x[5], t, u, v)
	u, v, p[4] = madd(p[8], 10744876698608693643, t, u, v)
	t, u, v = madd(z[6], x[8], 0, u, v)
	t, u, v = madd(p[6], 8185770922647689293, t, u, v)
	t, u, v = madd(z[7], x[7], t, u, v)
	t, u, v = madd(p[7], 3076118948115518168, t, u, v)
	t, u, v = madd(z[8], x[6], t, u, v)
	u, v, p[5] = madd(p[8], 2921755808891797364, t, u, v)
	t, u, v = madd(z[7], x[8], 0, u, v)
	t, u, v = madd(p[7], 8185770922647689293, t, u, v)
	t, u, v = madd(z[8], x[7], t, u, v)
	u, v, p[6] = madd(p[8], 3076118948115518168, t, u, v)
	t, u, v = madd(z[8], x[8], t, u, v)
	u, v, p[7] = madd(p[8], 8185770922647689293, t, u, v)
