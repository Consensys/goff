...
// testing ADDE2, SubE2
type {{.ElementName}}2 struct {
	a, b {{.ElementName}}
}
var b2Res{{.ElementName}} {{.ElementName}}2


func BenchmarkAdd{{toUpper .ElementName}}2(b *testing.B) {
	b2Res{{.ElementName}}.a.SetRandom()
	b2Res{{.ElementName}}.b.SetRandom()
	var x, y {{.ElementName}}2
	x.a.SetRandom()
	x.b.SetRandom()
	y.a.SetRandom()
	y.b.SetRandom()
...
func BenchmarkDouble{{toUpper .ElementName}}2(b *testing.B) {
	b2Res{{.ElementName}}.a.SetRandom()
	b2Res{{.ElementName}}.b.SetRandom()
	var x {{.ElementName}}2
	x.a.SetRandom()
...
func BenchmarkNeg{{toUpper .ElementName}}2(b *testing.B) {
	b2Res{{.ElementName}}.a.SetRandom()
	b2Res{{.ElementName}}.b.SetRandom()
	var x {{.ElementName}}2
	x.a.SetRandom()
...
func BenchmarkSub{{toUpper .ElementName}}2(b *testing.B) {
	b2Res{{.ElementName}}.a.SetRandom()
	b2Res{{.ElementName}}.b.SetRandom()
	var x, y {{.ElementName}}2
	x.a.SetRandom()
...
func Test{{toUpper .ElementName}}SubE2(t *testing.T) {
	...
	properties.Property("sub E2 should produce same result than twice sub e", prop.ForAll(
		func(a, b,c ,d testPair{{.ElementName}}) bool {
			var e, f, g {{.ElementName}}2
			e.a = a.element
			e.b = b.element
			f.a = c.element
			f.b = d.element
...
func Test{{toUpper .ElementName}}NegE2(t *testing.T) {
...
func Test{{toUpper .ElementName}}DoubleE2(t *testing.T) {
...
func Test{{toUpper .ElementName}}AddE2(t *testing.T) {
